...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String CAT_7 = "Save_Invest_Debt";
    ...
    private static final String CREATE_OVERVIEW_TABLE = "CREATE TABLE " +
            OVERVIEW + "(" + Budget_COL + " DOUBLE," + Spent_COL + " DOUBLE," +
    ...
    public static final String SIB = "sib_table";
    ...
    private static final String CREATE_SIB_TABLE = "CREATE TABLE " + SIB + "(" + COL_1 + " INTEGER PRIMARY KEY AUTOINCREMENT," + COL_2 + " TEXT," + COL_3 + " DOUBLE," + COL_4 + " TEXT" + ")";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS "+ SIB); 
    ...
    public boolean insertData(String name,Double price,String date) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(COL_2,name);
        contentValues.put(COL_3,price);
        contentValues.put(COL_4,date);
        long result = db.insert(HOUSING,null ,contentValues);
        if(result == -1)
            return false;
        else
            return true;
